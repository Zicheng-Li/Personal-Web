...
function Footer() {
  ...
  <div className="flex flex-col space-y-4 items-start">
    <div  className='text-teal-400 font-medium text-base'>Go To</div>
    ...
    <div className="flex flex-col space-y-4 items-start">
    <div  className='text-teal-400 font-medium text-base'>Elsewhere</div>
    ...
    <div className="flex flex-col space-y-4 items-start">
        <div className='text-teal-400 font-medium text-base '>Contact</div>
